...
set env="Z:\Git\Flappy_bird\Builds\Windows\Curr18e\Flappy_bird.exe"
set run_name=Curr18e1
...
mlagents-learn ARLPCG_curriculum_6_GPU.yaml --num-envs=20 --run-id=%run_name% --env=%env%  --no-graphics --torch-device=cuda --time-scale=5 --resume 
