...
set run_name=InferenceCurr42d_Fixed_2
set initRUN_ID=Fixed_2
...
mlagents-learn inference.yaml --num-envs=10 --run-id=%run_name% --env=%env%   --no-graphics --torch-device=cuda --time-scale=1 --inference --initialize-from=%initRUN_ID% --base-port=5080
