...
mlagents-learn ARLPCG_solver_inference.yaml --num-envs=20 --run-id=%run_name% --env=%env%   --no-graphics --torch-device=cuda --time-scale=7 --inference --initialize-from=%initRUN_ID% --force
