...
set env="Z:\Git\Flappy_bird\Builds\Windows\PCG_Const_1\Flappy_bird.exe"
set run_name=PCG_Const_1
...
:: Execute this
mlagents-learn PCG.yaml  --num-envs=10 --run-id=%run_name%  --no-graphics --torch-device=cuda --time-scale=1  --env=%env% --force
