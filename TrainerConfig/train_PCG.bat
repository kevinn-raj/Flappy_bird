...
set env="Z:\Git\Flappy_bird\Builds\Windows\Fixed\Flappy_bird.exe"
set run_name=Fixed_2
...
:: Execute this
mlagents-learn PCG.yaml  --num-envs=10 --run-id=%run_name%  --no-graphics --torch-device=cuda --time-scale=1  --env=%env%
